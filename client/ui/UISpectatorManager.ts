module Kodo {
    export class UISpectatorManager {
        ...
        goldLabelC: Phaser.Text;
        woodLabelC: Phaser.Text;

        goldIconC: Phaser.Sprite;
        woodIconC: Phaser.Sprite;

        incomeBarC: IncomeBar;
        ...
        constructor(game: Phaser.Game) {
            ...
            this.incomeBarC = new IncomeBar(this.game, 1000);
        }

        startGame() {
            new WarningMessage(this.game, 'Entered the Arena!');
        }
