...
(function (Kodo) {
    var UpdateManager = (function () {
        function UpdateManager(game) {
            this.currentTime = 0;
            this.timeToMove = GameConfig.updateRate / 1000 + 0.045;
            this.game = game;
            this.smooth = 0;
            this.maxLenght = 42;
            ...
            this.uIUpdateButton = new Kodo.UIUpdateButton(game, updateButton);
        }
        ...
        UpdateManager.prototype.updateCounter = function (counter) {
            ...
            if (counter == 0) {
                ...
                tweenA.chain(tweenB);
                tweenA.start();
                new Kodo.WarningMessage(this.game, "+1 Upgrade Point", '#40f08b');
            }
        };
        return UpdateManager;
    }());
    Kodo.UpdateManager = UpdateManager;
})(Kodo || (Kodo = {}));
