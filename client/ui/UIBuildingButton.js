...
(function (Kodo) {
    var UIBuildingButton = (function (_super) {
        ...
        UIBuildingButton.prototype.updateTextPos = function () {
            this.goldCostText.x = Math.round(this.world.x + 15);
            this.goldCostText.y = Math.round(this.world.y + this.height + 15);
            this.woodCostText.x = Math.round(this.world.x + this.width - 15);
            this.woodCostText.y = Math.round(this.world.y + this.height + 15);
        };
