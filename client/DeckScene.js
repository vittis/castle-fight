    ...
    var DeckScene = (function (_super) {
        ...
        DeckScene.prototype.create = function () {
            ...
            GameConfig.deck.forEach(function (name) {
                ...
                _this.yourDeckGroup.add(new Kodo.UIBuildingButton(game, name[0].toLowerCase() + name.slice(1) + "_ui_" + hostLabel, _this, name[0].toLowerCase() + name.slice(1) + "" + hostLabel, name));
            });
            GameConfig.buildingNameData.forEach(function (name) {
                var q = _this.buildingsGroup.add(new Kodo.UIBuildingButton(game, name[0].toLowerCase() + name.slice(1) + "_ui_" + hostLabel, _this, name[0].toLowerCase() + name.slice(1) + "" + hostLabel, name));
        ...
        DeckScene.prototype.onDown = function (sprite) {
            ...
            if (this.deck.indexOf(sprite.buildingName) == -1 && this.deck.length < 8) {
                this.yourDeckGroup.add(new Kodo.UIBuildingButton(this.game, sprite.spriteName, this, sprite.previewName, sprite.buildingName));
                this.yourDeckGroup.setAll('anchor.x', 0.5);
                this.yourDeckGroup.setAll('anchor.y', 0.5);
                this.yourDeckGroup.align(4, 2, 110, 90);
