    ...
    var DeckScene = (function (_super) {
        ...
        DeckScene.prototype.create = function () {
            ...
            GameConfig.buildingNameData.forEach(function (name) {
                var q = _this.buildingsGroup.add(new Kodo.UIBuildingButton(_this.game, name[0].toLowerCase() + name.slice(1) + "_ui_" + hostLabel, _this, name[0].toLowerCase() + name.slice(1) + "" + hostLabel, name, false, i > 14 ? false : true));
